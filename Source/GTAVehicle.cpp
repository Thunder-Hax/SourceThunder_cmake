...
{
	if (!checkIfDamaged || VEHICLE::_IS_VEHICLE_DAMAGED(this->mHandle))
	{
		VEHICLE::SET_VEHICLE_FIXED(this->mHandle);
		VEHICLE::SET_VEHICLE_DIRT_LEVEL(this->mHandle, 0);
		VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(this->mHandle, 0);
		VEHICLE::SET_VEHICLE_ENGINE_HEALTH(this->mHandle, 2000.0f);
		VEHICLE::SET_VEHICLE_PETROL_TANK_HEALTH(this->mHandle, 2000.0f);
		VEHICLE::SET_VEHICLE_BODY_HEALTH(this->mHandle, 2000.0f);
		VEHICLE::SET_VEHICLE_UNDRIVEABLE(this->mHandle, 0);
		VEHICLE::SET_VEHICLE_ENGINE_ON2(this->mHandle, 1, 1);
	}
}
...
{
	return VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT(this->mHandle);
}
...
{
	VEHICLE::SET_VEHICLE_FORWARD_SPEED(this->mHandle, value);
}
...
{
	int colour1, colour2;
	VEHICLE::GET_VEHICLE_COLOURS(this->mHandle, &colour1, &colour2);
	return colour1;
}
...
{
	int colour1, colour2;
	VEHICLE::GET_VEHICLE_EXTRA_COLOURS(this->mHandle, &colour1, &colour2);
	return colour2;
}
...
//		return 0;*/
//	int col;
//	VEHICLE::_0x7D1464D472D32136(this->mHandle, &col);
//	return col;
//}
...
//	//	return 0;
//	int col;
//	VEHICLE::_0xB7635E80A5C31BFF(this->mHandle, &col);
//	return col;
//}
...
//		return 0;*/
//	return VEHICLE::_0x3DFF319A831E0CDB(this->mHandle);
//}
...
{
	return VEHICLE::GET_IS_VEHICLE_PRIMARY_COLOUR_CUSTOM(this->mHandle) != 0;
}
bool GTAvehicle::IsSecondaryColorCustom() const
{
	return VEHICLE::GET_IS_VEHICLE_SECONDARY_COLOUR_CUSTOM(this->mHandle) != 0;
}
...
{
	int r, g, b;
	VEHICLE::GET_VEHICLE_CUSTOM_PRIMARY_COLOUR(this->mHandle, &r, &g, &b);
	return RgbS(r, g, b);
}
...
{
	int r, g, b;
	VEHICLE::GET_VEHICLE_CUSTOM_SECONDARY_COLOUR(this->mHandle, &r, &g, &b);
	return RgbS(r, g, b);
}
...
{
	int r, g, b;
	VEHICLE::GET_VEHICLE_TYRE_SMOKE_COLOR(this->mHandle, &r, &g, &b);
	return RgbS(r, g, b);
}
...
{
	return VEHICLE::GET_VEHICLE_LIVERY(this->mHandle);
}
...
{
	VEHICLE::SET_VEHICLE_TYRE_FIXED(this->mHandle, wheel);
}

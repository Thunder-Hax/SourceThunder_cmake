...
#define STEAM_ADDRESS_WORLD 0x24b0c50
#define SC_ADDRESS_WORLD 0x24acb48
#define Epic_World 0x252DCD8
...
#define OFFSET_ENTITY_GOD				0x188 //0x189			//godmode; on = 1, off = 0; byte
...
//player
#define OFFSET_PLAYER_VEHICLE					0x508 //0xD30			//ptr to last used vehicle
#define OFFSET_NET_PLAYER_INFO					0xB0
#define OFFSET_PLAYER_INFO						0x10A8/*0x10C8*/			//playerInfo struct
#define OFFSET_PLAYER_INFO_NAME					0xA4
#define OFFSET_PLAYER_INFO_SWIM_SPD				0x1C8 //0x1D0 //0x170			//swim speed; def 1; float
#define	OFFSET_PLAYER_INFO_RUN_SPD				0xD50//0xD40//0xD50 //0xCF0			//run speed; def 1; float
#define OFFSET_PLAYER_INFO_FRAMEFLAGS			0x270 //0x278 //0x218 //0x219			//frame flags; DWORD
...
#define OFFSET_PLAYER_INFO_WANTED				0x8E8 //0x8E5 //0x8D8 //0x8E8 //0x888			//wanted level; DWORD
#define OFFSET_PLAYER_INFO_STAMINA				0xD5C //0xD54 //0xCF4			//fStamina, fStaminaMax
#define OFFSET_PLAYER_INFO_STAMINA_MAX			0xD58 
